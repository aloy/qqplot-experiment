...
& estimates & \bf low & \bf high && odds &  \bf low & \bf high \\ 
 \cline{2-4} \cline{6-8}
%  \hline
  Intercept & \bf -5.27 & \bf -6.69 & \bf -3.86 && \bf 0.01 & \bf 0.00 & \bf 0.02 \\ [3pt]
\multicolumn{1}{l}{\bf design (CI)} \\  
Control & 0.00 & \multicolumn{2}{c}{---} && 1.00 & \multicolumn{2}{c}{---}\\
Standard (HD) & 0.06 & -0.13 & 0.25 && 1.06 & 0.88 & 1.29 \\ 
  Standard (TS) & -0.18 & -0.40 & 0.04 && 0.84 & 0.67 & 1.04 \\ [2pt]
    Detrended2 (HD) & \bf -0.43 & \bf-0.61 & \bf -0.25 && \bf 0.65 & \bf 0.54 & \bf 0.78 \\ 
  Detrended2 (TS) & 0.00 & -0.21 & 0.22 && 1.00 & 0.81 & 1.25 \\ [2pt]
%
Detrended (HD) & \bf 0.41 & \bf 0.19 & \bf 0.62 && \bf 1.50 & \bf 1.21 & \bf 1.86 \\ 
  Detrended (TS) & \bf 0.30 & \bf 0.08 & \bf 0.51 && \bf 1.35 & \bf 1.09 & \bf 1.67 \\ [3pt]
\multicolumn{1}{l}{\bf sample size} \\  
20 & 0.00 & \multicolumn{2}{c}{---} && 1.00 & \multicolumn{2}{c}{---}\\
  30 & 1.10 & -0.39 & 2.60 && 3.01 & 0.67 & 13.44 \\ 
  50 & \bf 2.99 & \bf 1.49 & \bf 4.49 && \bf 19.80 & \bf 4.42 & \bf 88.82 \\ 
  75 & \bf 2.28 & \bf 0.78 & \bf 3.78 && \bf 9.79 & \bf 2.18 & \bf 43.96 \\ [3pt]
\multicolumn{1}{l}{\bf degrees of freedom} \\  
2 & 0.00 & \multicolumn{2}{c}{---} && 1.00 & \multicolumn{2}{c}{---}\\
 5 & \bf -3.67 & \bf -4.97 & \bf -2.37 && \bf 0.03 & \bf 0.01 & \bf 0.09 \\ 
 10 & \bf -5.99 & \bf -7.31 & \bf -4.68 && \bf 0.00 & \bf 0.00 & \bf 0.01 \\ 
\cline{2-4} \cline{6-8}
...
\begin{tabular}{rrrrrl}
  ...
  &\bf Estimate &\bf Std. Error &\bf z value &\bf Pr($>$$|$z$|$) & \\ 
   \hline
 Intercept & 1.19 & 0.662 & 1.80 & 0.0713 & .\\ [3pt]
 \multicolumn{3}{l}{\bf design (CI)} \\
   Control & 0.00 & ----- & ----- & ----- \\ [2pt]
  Standard (HD) & 0.10 & 0.092 & 1.05 & 0.2923 \\ 
  Standard (TS) & -0.18 & 0.111 & -1.60 & 0.1093 \\ [2pt]
   Detrended2 (HD) & -0.43 & 0.093 & -4.63 & 0.0000 & ***\\ 
   Detrended2 (TS) & 0.00 & 0.110 & 0.04 & 0.9691 \\ [2pt]
   Detrended (HD) & 0.41 & 0.110 & 3.70 & 0.0002 & ***\\ 
   Detrended (TS) & 0.30 & 0.109 & 2.73 & 0.0063 & **\\ [3pt]
 \multicolumn{3}{l}{\bf degrees of freedom} \\
   2 & 0.00 & ----- & ----- & ----- \\ 
   5 & -3.67 & 0.662 & -5.54 & 0.0000 & ***\\ 
   10 & -5.99 & 0.671 & -8.94 & 0.0000 & ***\\ [3pt]
 \multicolumn{3}{l}{\bf sample size} \\
   20 & 0.00 & ----- & ----- & ----- \\ 
   30 & 1.10 & 0.764 & 1.44 & 0.1489 \\ 
   50 & 2.99 & 0.766 & 3.90 & 0.0001 & ***\\ 
   75 & 2.28 & 0.766 & 2.98 & 0.0029 & **\\ 
    \hline
