...
\hhnote{XXX lead into the three different designs}

For all of the variations of Q-Q plots considered in this paper, a line representing the theoretical distribution is drawn explicitly.
