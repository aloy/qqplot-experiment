...
\begin{figure}[ht]
\centering
<<compare-designs, echo=FALSE, fig.width=14, fig.height=8.5, out.width='\\textwidth', warning=FALSE, message=FALSE>>=
...
\bf Design & \multicolumn{2}{c}{\bf Standard} & \multicolumn{2}{c}{\bf adj. Detrended} & \multicolumn{2}{c}{\bf ord. Detrended} & \bf Control \\
...
$u$ & the users' subjective \al{(XXX individual?)} abilities.
 \end{tabular}
\end{center}
%
