...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# \\\#\# Attaching package: 'lubridate'\\\#\# \\\#\# The following object is masked from 'package:plyr':\\\#\# \\\#\#\ \ \ \  here}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'sw' not found}}\end{kframe}
\end{knitrout}
\begin{figure}
\centering
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: Matrix\\\#\# Loading required package: Rcpp}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'Formula' was built under R version 3.1.1}}\end{kframe}
\end{knitrout}
