...
\hhnote{Could we back off the normal distributed errors, and just assume $E[\varepsilon] =0$ and Var$[\varepsilon]=\sigma^2$? Otherwise we're directly contradicting the logit link and assuming a probit link. Not that it matters so much in practice, but the errors should be from a logistic distribution....}
