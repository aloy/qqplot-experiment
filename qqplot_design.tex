...
\alnote{Alternative (based on editor's comment):
However, when a line is plotted alongside the points in the Q-Q plot, the parameters $\mu$ and $\sigma$ have to be estimated from the sample. 
}
...
\al{In order to follow this recommendation} we are investigating the power of detrended Q-Q plots. In particular
