...
Under both the standard design and the detrended (1)  design there are 2 lineups each with different outcomes. Under the detrended (2) design there are 4 lineups with different outcomes. They are shown in figures~\ref{fig:lpsstds},~\ref{fig:lpsdt1}, and~\ref{fig:lpsdt2}, respectively. 
...
\begin{verbatim}
## [1] "data-2-2-18-30-5-8-16.csv"
## [1] "data-2-2-20-75-5-12-19.csv"
\end{verbatim}
\end{kframe}
