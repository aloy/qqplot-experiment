...
% print(xtable(dc))
\begin{table}[ht]
\caption{\label{tab:coefs} Linear estimates and corresponding odds based on Model (1).  95\% Wald confidence intervals are given in parentheses. \hh{Significant values are bolded. For parameters serving as baselines no confidence intervals exist.}}
\centering
