...
\item
The simulation study here is only concerned with deviations from normality as given by the $t$-distribution. We could have considered other types of deviations such as skewness or mixed distributions. We don't think that the results would have changed much. 

Extension: skew distribution versus normal distribution? TS test, normality tests with robust parameters: problem with coding this ourselves: algorithm might use properties of ML estimators
\end{enumerate}
